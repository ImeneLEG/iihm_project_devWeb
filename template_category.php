...
<header>
  ...
  <div class="container-all">
    ...
    <script src="category_pages_html/proj.js" type="module"></script>  
    <!-- <script src="category_pages_html/rating-system.js" type="module"></script> -->
    ...
    <script>
      ...
      function rating(num) {
        ...
        $.ajax({
          type: "POST",
          url: "category_pages_html/data-submit.php",
          data: { title: title },
